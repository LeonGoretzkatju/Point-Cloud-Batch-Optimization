function [Pose,Reason,Info,index] = FuncLeastSquares22(Map,Pose,Scan,Odom,MODE_DERIVATIVES,FILE_DIRECTORY,MAX_ITER,MODE_MAP,...
   Low_Scan,Size_i,Size_j,Scale,Origin,DOWN_TIME,Lambda_O,Lambda_N,MULTI_MODE,EVALUTION_GT,Pose_GT,Rate,KERNEL_SIZE)
tic;
